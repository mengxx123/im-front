            ...
            <div id="doc">
                <div id="chat">
                    ...
                    <div class="input-box">
                        ...
                        <div>
                            <router-link to="/chatlog">聊天记录</router-link>
                            <mu-raised-button label="提醒" @click="notice" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        mounted() {
            ...
            w.CHAT = {
                ...
                init:function(username){
                    ...
                    // this.socket = io.connect('ws://localhost:1030');
...
//            };
        ...
        methods: {
            notice() {
                ...
                this.chat.socket.emit('message', obj)
            }
        }
    }
</script>
